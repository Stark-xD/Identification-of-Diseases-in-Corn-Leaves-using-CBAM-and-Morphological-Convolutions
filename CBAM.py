...
class Morphology(nn.Module):
    def __init__(self, in_channels, out_channels, kernel_size=3, soft_max=True, beta=15, type=None):
    ...
    def forward(self, x):
        ...
        #print(x.shape,weight.shape,self.type)
...
class Dilation2d(Morphology):
    def __init__(self, in_channels, out_channels, kernel_size=3, soft_max=True, beta=20):
...
class SpatialMorph(nn.Module):
    def __init__(self,FM,NC):
        super(SpatialMorph, self).__init__()
        self.erosion = Erosion2d(FM,NC, 3, soft_max=False)
        self.conv1 = nn.Conv2d(NC,NC,(1,1),padding=1)
        self.dilation = Dilation2d(FM,NC, 3, soft_max=False)
        self.conv2 = nn.Conv2d(NC,NC,(1,1),padding=1)
